...
from data_lib import CocoCaptionDataset, ImageCaptionCollate, encode_captions, split_dataset
from training import (build_scheduler, build_new_module_optimizer,
...
class DpoDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self._cache is not None:
            ...
            from data_lib import preprocess_image_path
